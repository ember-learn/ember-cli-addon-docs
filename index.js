...
module.exports = {
  ...
  included(includer) {
    ...
    includer.options.snippetRegexes = Object.assign({}, {
      begin: /{{#(?:docs-snippet|demo.example|demo.liveExample)\sname=(?:"|')(\S+)(?:"|')/,
      end: /{{\/(?:docs-snippet|demo.example|demo.liveExample)}}/,
...
class AutoExportAddonToApp extends Plugin {
  build() {
    ...
    [ 'adapters', 'controllers', 'helpers', 'models', 'routes', 'services', 'serializers', 'transitions' ].forEach(moduleType => {
